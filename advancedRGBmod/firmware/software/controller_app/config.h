...
#define CFG_MENU_GETALL_MASK    0x3F
...
#define CFG_SHOWOSDWARN_OFFSET  2
#define CFG_SHOWOSDINFO_OFFSET  1
...
#define CFG_SHOWOSDWARN_GETMASK   (1<<CFG_SHOWOSDWARN_OFFSET)
#define CFG_SHOWOSDWARN_SETMASK   (1<<CFG_SHOWOSDWARN_OFFSET)
#define CFG_SHOWOSDWARN_CLRMASK   (CFG_MENU_GETALL_MASK & ~CFG_SHOWOSDWARN_SETMASK)
#define CFG_SHOWOSDINFO_GETMASK   (1<<CFG_SHOWOSDINFO_OFFSET)
#define CFG_SHOWOSDINFO_SETMASK   (1<<CFG_SHOWOSDINFO_OFFSET)
#define CFG_SHOWOSDINFO_CLRMASK   (CFG_MENU_GETALL_MASK & ~CFG_SHOWOSDINFO_SETMASK)
