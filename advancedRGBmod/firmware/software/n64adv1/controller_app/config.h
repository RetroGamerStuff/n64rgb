...
#define CFG_VIDEO_GETALL_MASK     0x1F1F7F3F
...
#define CFG_FILTERADDON_OFFSET  26
...
#define CFG_DEBLUR_STAB_OFFSET   4
#define CFG_DEBLUR_RST_OFFSET    2
#define CFG_DEBLUR_MODE_OFFSET   0
...
#define CFG_DEBLUR_FCNT_HIGH_GETMASK  (7<<CFG_DEBLUR_FCNT_HIGH_OFFSET)
  #define CFG_DEBLUR_FCNT_HIGH_RSTMASK  (CFG_VIDEO_GETALL_MASK & ~CFG_DEBLUR_FCNT_HIGH_GETMASK)
#define CFG_DEBLUR_FCNT_LOW_GETMASK   (7<<CFG_DEBLUR_FCNT_LOW_OFFSET)
  #define CFG_DEBLUR_FCNT_LOW_RSTMASK   (CFG_VIDEO_GETALL_MASK & ~CFG_DEBLUR_FCNT_LOW_GETMASK)
#define CFG_DEBLUR_STAB_GETMASK       (3<<CFG_DEBLUR_STAB_OFFSET)
  #define CFG_DEBLUR_STAB_RSTMASK       (CFG_VIDEO_GETALL_MASK & ~CFG_DEBLUR_STAB_GETMASK)
#define CFG_DEBLUR_RST_GETMASK        (3<<CFG_DEBLUR_RST_OFFSET)
  #define CFG_DEBLUR_RST_RSTMASK        (CFG_VIDEO_GETALL_MASK & ~CFG_DEBLUR_RST_GETMASK)
#define CFG_DEBLUR_MODE_GETMASK       (3<<CFG_DEBLUR_MODE_OFFSET)
  #define CFG_DEBLUR_MODE_RSTMASK       (CFG_VIDEO_GETALL_MASK & ~CFG_DEBLUR_MODE_GETMASK)
    #define CFG_DEBLUR_MODE_ON_SETMASK    (2<<CFG_DEBLUR_MODE_OFFSET)
    #define CFG_DEBLUR_MODE_OFF_SETMASK   (1<<CFG_DEBLUR_MODE_OFFSET)
    #define CFG_DEBLUR_MODE_AUTO_SETMASK  (0<<CFG_DEBLUR_MODE_OFFSET)
...
#define CFG_240P_LINEX_GETMASK        (3<<CFG_240P_LINEX_OFFSET)
  #define CFG_240P_LINEX_RSTMASK        (CFG_IMAGE_GETALL_MASK & ~CFG_240P_LINEX_GETMASK)
#define CFG_240P_SLHYBDEP_GETMASK     (0x1F<<CFG_240P_SLHYBDEP_OFFSET)
  #define CFG_240P_SLHYBDEP_RSTMASK     (CFG_IMAGE_GETALL_MASK & ~CFG_240P_SLHYBDEP_GETMASK)
  #define CFG_240P_SLHYBDEP_CLRMASK     (CFG_IMAGE_GETALL_MASK & ~CFG_240P_SLHYBDEP_GETMASK)
#define CFG_240P_SLSTR_GETMASK        (0xF<<CFG_240P_SLSTR_OFFSET)
  #define CFG_240P_SLSTR_RSTMASK        (CFG_IMAGE_GETALL_MASK & ~CFG_240P_SLSTR_GETMASK)
#define CFG_240P_SLSTR_CLRMASK        (CFG_IMAGE_GETALL_MASK & ~CFG_240P_SLSTR_GETMASK)
...
#define CFG_480I_BOB_DEINTER_GETMASK  (1<<CFG_480I_BOB_DEINTER_OFFSET)
  ...
  #define CFG_480I_BOB_DEINTER_CLRMASK  (CFG_IMAGE_GETALL_MASK & ~CFG_480I_BOB_DEINTER_GETMASK)
#define CFG_480I_SLHYBDEP_GETMASK     (0x1F<<CFG_480I_SLHYBDEP_OFFSET)
  #define CFG_480I_SLHYBDEP_RSTMASK     (CFG_IMAGE_GETALL_MASK & ~CFG_480I_SLHYBDEP_GETMASK)
#define CFG_480I_SLHYBDEP_CLRMASK       (CFG_IMAGE_GETALL_MASK & ~CFG_480I_SLHYBDEP_GETMASK)
#define CFG_480I_SLSTR_GETMASK        (0xF<<CFG_480I_SLSTR_OFFSET)
  #define CFG_480I_SLSTR_RSTMASK        (CFG_IMAGE_GETALL_MASK & ~CFG_480I_SLSTR_GETMASK)
  #define CFG_480I_SLSTR_CLRMASK        (CFG_IMAGE_GETALL_MASK & ~CFG_480I_SLSTR_GETMASK)
#define CFG_480I_SL_LINK240P_GETMASK  (1<<CFG_480I_SL_LINK240P_OFFSET)
  ...
  #define CFG_480I_SL_LINK240P_CLRMASK  (CFG_IMAGE_GETALL_MASK & ~CFG_480I_SL_LINK240P_GETMASK)
#define CFG_480I_SL_ID_GETMASK        (1<<CFG_480I_SL_ID_OFFSET)
  #define CFG_480I_SL_ID_SETMASK        (1<<CFG_480I_SL_ID_OFFSET)
  #define CFG_480I_SL_ID_CLRMASK        (CFG_IMAGE_GETALL_MASK & ~CFG_480I_SL_ID_SETMASK)
#define CFG_480I_SL_EN_GETMASK        (1<<CFG_480I_SL_EN_OFFSET)
  #define CFG_480I_SL_EN_SETMASK        (1<<CFG_480I_SL_EN_OFFSET)
  #define CFG_480I_SL_EN_CLRMASK        (CFG_IMAGE_GETALL_MASK & ~CFG_480I_SL_EN_SETMASK)
...
#define CFG_DEBLUR_FCNT_HIGH_MAX_VALUE   5
#define CFG_DEBLUR_FCNT_LOW_MAX_VALUE    6
#define CFG_DEBLUR_STAB_MAX_VALUE        3
#define CFG_DEBLUR_RST_MAX_VALUE         3
#define CFG_DEBLUR_MODE_MAX_VALUE        2
...
#define CFG_DEBLUR_FCNT_HIGH_DEFAULTVAL       1
  #define CFG_DEBLUR_FCNT_HIGH_DEFAULT_SETMASK  (CFG_DEBLUR_FCNT_HIGH_DEFAULTVAL  << CFG_DEBLUR_FCNT_HIGH_OFFSET)
#define CFG_DEBLUR_FCNT_LOW_DEFAULTVAL        1
  #define CFG_DEBLUR_FCNT_LOW_DEFAULT_SETMASK   (CFG_DEBLUR_FCNT_LOW_DEFAULTVAL  << CFG_DEBLUR_FCNT_LOW_OFFSET)
#define CFG_DEBLUR_STAB_DEFAULTVAL            2
  #define CFG_DEBLUR_STAB_DEFAULT_SETMASK       (CFG_DEBLUR_STAB_DEFAULTVAL  << CFG_DEBLUR_STAB_OFFSET)
#define CFG_DEBLUR_RST_DEFAULTVAL             2
  #define CFG_DEBLUR_RST_DEFAULT_SETMASK        (CFG_DEBLUR_RST_DEFAULTVAL <<  CFG_DEBLUR_RST_OFFSET)
...
#define CFG_VIDEO_DEFAULT         (CFG_VFORMAT_DEFAULT_SETMASK | CFG_GAMMA_DEFAULT_SETMASK | CFG_DEBLUR_FCNT_HIGH_DEFAULT_SETMASK | \
                                   CFG_DEBLUR_FCNT_LOW_DEFAULT_SETMASK | CFG_DEBLUR_STAB_DEFAULT_SETMASK | CFG_DEBLUR_RST_DEFAULT_SETMASK)
  #define CFG_VIDEO_GET_NODEFAULTS  (CFG_VFORMAT_GETMASK)
#define CFG_IMAGE_DEFAULT         (CFG_240P_SL_METHOD_DEFAULT_SETMASK | CFG_480I_FIELDFIX_SETMASK | CFG_480I_SL_LINK240P_DEFAULTVAL)
  #define CFG_IMAGE_GET_NODEFAULTS  0x0000
