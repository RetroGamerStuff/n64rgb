...
#define CFG_IGR15BITMODE_GETMASK  (1<<CFG_IGR15BITMODE_OFFSET)
  #define CFG_IGR15BITMODE_SETMASK  (1<<CFG_IGR15BITMODE_OFFSET)
  #define CFG_IGR15BITMODE_CLRMASK  (CFG_MISC_GETALL_MASK & ~CFG_IGR15BITMODE_SETMASK)
...
#define CFG_VIDEO_GETNONTIMINGS_MASK  (CFG_VFORMAT_GETMASK | CFG_GAMMA_GETMASK | CFG_DEBLUR_MODE_GETMASK | CFG_15BITMODE_GETMASK)
