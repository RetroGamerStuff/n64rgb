...
config_t sl_method = {
    .cfg_word        = &cfg_data_image240p,
    .cfg_word_offset = CFG_SL_METHOD_OFFSET,
    .cfg_type        = FLAG,
    .flag_masks   = {
        .setflag_mask = CFG_SL_METHOD_SETMASK,
        .clrflag_mask = CFG_SL_METHOD_CLRMASK
    },
    .value_string = &AdvSL
};
...
config_t sl_link_480i = {
    .cfg_word        = &cfg_data_image480i,
    .cfg_word_offset = CFG_SL_LINK240P_OFFSET,
    .cfg_type        = FLAG,
    .flag_masks   = {
        .setflag_mask = CFG_SL_LINK240P_SETMASK,
        .clrflag_mask = CFG_SL_LINK240P_CLRMASK
    },
    .value_string = &LinkSL
};
