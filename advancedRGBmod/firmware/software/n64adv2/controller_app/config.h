...
#define N64_IMAGE240P_CLR_MASK  (CFG_SL_EN_CLRMASK)
#define N64_IMAGE480I_CLR_MASK  (CFG_SL_EN_CLRMASK)

#define N64_DEFAULT_VIDEO_CFG     (CFG_GAMMA_DEFAULT_SETMASK | CFG_DEBLUR_OFF_SETMASK)
#define N64_DEFAULT_IMAGE240P_CFG (CFG_LINEX2_SETMASK)
#define N64_DEFAULT_IMAGE480I_CFG (CFG_LINEX2_SETMASK)
